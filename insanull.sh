...
{
    echo
    figlet -f ~/GUI-based-Age-Calculator/font/3-D.flf  "INSTA NULL" | lolcat -a -d 500
    echo
}
...
read -p $' \e[1;32m[\e[0m\e[1;31m::\e[0m\e[1;32m]\e[0m\e[1;77m Choose an option: \e[0m' option
